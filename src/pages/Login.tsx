...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Welcome back to Rizq Market!");
      navigate("/");
    } catch (error: any) {
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12 bg-emerald-50/30">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl shadow-emerald-100/50 p-8 border border-emerald-100">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-bold text-emerald-900">Sign In</h2>
          <p className="text-emerald-600/60 mt-2">Access your account and orders</p>
        </div>
